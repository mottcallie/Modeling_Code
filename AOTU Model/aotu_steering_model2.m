...
% startPos - starting position of simulation (0-180)
...
% input_history - summed input from all visual neurons for all repeated runs
...
% initialize
input_history = zeros(numRuns,nTime,2); % input to DNs for right(1) and left(2)
...
for t=3:nTime
    ...
    input_history(:,t,2) = current_inputL; %left
