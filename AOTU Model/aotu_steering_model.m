...
% AOTU019synapse - modify AOTU019 synapse
% possible inputs: excitatory, inhibitory, slow
% AOTUoverlap - modify AOTU019 binocular overlap
% possible inputs: normal,medium,low,none
...
function [AOTU019,AOTU025,timebase,visobj_history] = aotu_steering_model(noiseLevel,AOTU019synapse,AOTU019overlap,nTime)
%% initialize
...
f25 = 2; %AOTU025 frequency modifier, increase to reduce tuning width
c25 = 100; %AOTU025 center of tuning curve

% simulation variables
numRuns=200; % number of times to run the simulation
