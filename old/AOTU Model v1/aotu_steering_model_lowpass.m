...
%
% INPUTS
% lowCutOff - lowpass cutoff frequency (Hz)
...
function [AOTU019,AOTU025,timebase,visobj_history] = aotu_steering_model_lowpass( ...
    lowCutOff,noiseLevel,startPos,AOTU019synapse,AOTU019strength,nTime)
%% initialize
...
fpass = lowCutOff; % lowpass cutoff for random component, in Hz
