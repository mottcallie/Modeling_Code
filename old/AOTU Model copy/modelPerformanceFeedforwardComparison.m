...
startPos = 0;
simDuration = 30;
scaleFactors = [0, 1, 2, 5, 10];  % Scaling factors for the feedforward input (0 = no feedforward, 5 = max feedforward)
...
generateSummaryPlots2(kValues, metrics_prob, metrics_var, metrics_ISE, metrics_IAE, ...
    obj_binned_avgs, rotvel_binned_avgs, evt, obj_bins, rotvel_bins, posBins, nK, comparisonLabel, folder, "FeedforwardCL");
